...
const columns: Column[] = [
  ...
  { key: 'Yield Pct', label: 'Yield %', render: (v: any) => v != null ? `${v}%` : '\u2014' },
];
...
export function BOMClient({ data: initialData }: { data: Record<string, any>[] }) {
    ...
    <div>
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">BOM management &mdash; product structure and version control</p>
        </div>
      ...
      <div className="stat-row">
        <div className="stat-mini">
          ...
          <div className="label">Total BOMs</div>
        </div>
        <div className="stat-mini">
        ...
        <div className="stat-mini">
          <div className="value" style={{ color: '#f59e0b' }}>{stats.avgYield}%</div>
          <div className="label">Avg Yield</div>
        </div>
        <div className="stat-mini">
          <div className="value" style={{ color: '#06b6d4' }}>{stats.versions}</div>
        ...
        <div className="chart-card" style={{ marginBottom: 20 }}>
          ...
          <ResponsiveContainer width="100%" height={260}>
            <PieChart>
              ...
              <Tooltip {...CHART_TOOLTIP} formatter={(value: any) => [value, 'BOMs']} />
      ...
      <div className="table-container">
        <div className="toolbar">
          <h3 style={{ fontSize: 14, fontWeight: 700, color: 'var(--text)', margin: 0 }}>
            All BOMs <span style={{ fontWeight: 500, color: 'var(--text-dim)', fontSize: 12 }}>({filtered.length})</span>
          </h3>
          <div className="search-bar">
            ...
            <input className="input" placeholder="Search BOMs..." value={search} onChange={(e) => { setSearch(e.target.value); setPage(1); }} style={{ width: 260 }} />
          </div>
        </div>
